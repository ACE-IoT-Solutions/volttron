...
from volttron.platform.agent.base_historian import (
    BaseHistorian,
...
class MQTTHistorian(BaseHistorian):
    ...
    def publish_to_historian(self, to_publish_list):
        ...
        try:
            ...
            _log.warning(
                "Exception ({}) raised by publish: {}".format(e.__class__.__name__, e)
            )
...
def main(argv=sys.argv):
    try:
        utils.vip_main(MQTTHistorian, version=__version__)
    except Exception as e:
        print(e)
        _log.exception(e)
