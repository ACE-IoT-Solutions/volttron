...
class MQTTHistorian(BaseHistorian):
    ...
    def __init__(self, connection, site_slug, **kwargs):
        ...
        if self.site_slug is None:
            raise ValueError("site_slug must be specified")
    ...
    def publish_to_historian(self, to_publish_list):
        ...
        for x in to_publish_list:
            topic = f"syyclops/ace/{self.site_slug}/{x['topic']}"
